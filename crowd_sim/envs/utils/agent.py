...
class Agent(object):
    def __init__(self, config, section):
        ...
        self.theta = None
        self.time_step = None
        # The previous goal is needed to return the agent back
        self.previous_gx = None
        self.previous_gy = None
    ...
    def set(self, px, py, gx, gy, vx, vy, theta, radius=None, v_pref=None):
        ...
        if v_pref is not None:
            self.v_pref = v_pref
        # Because it is the initialisation of the agent, the previous goal is the start position
        self.previous_gx = px
        self.previous_gy = py
    ...
    def get_prev_goal_position(self):
        return self.previous_gx, self.previous_gy
